...
if menu == "Pedido Automático de Material":
    ...
    historico = pd.merge(inventory_df, items_df[['Item ID', 'Name']], on='Item ID', how='left')
    st.dataframe(historico[['Inventory ID', 'Item ID', 'Name', 'DateTime', 'Amount']], use_container_width=True)
